...
{
     echo "<a class='blue' href='/Other_system/classroom_system/Classroom8.php'><u>Home</u></a> | 
     <a class='blue' href='/Other_system/classroom_system/login.php?floor=8'><u>เข้าสู่ระบบ</u></a>&nbsp;";
}
else
{
    echo "<a class='blue' href='/Other_system/classroom_system/Classroom8.php'><u>Home</u></a> | 
    <a class='lightgreen' >".$_SESSION['user']."</a>&nbsp<a class='blue'  href='/Other_system/classroom_system/logout.php?floor=8'><u>Logout</u></a>&nbsp;";
}
?>
</div>
...
<div class="room"> 
		<div class="tab">
			<button class="tablinks" onclick="openCity(event, '803')" style="height:110px;width:28%;border-bottom:1px solid #000000;float:Right;">66803<br />
		<font size="2">(<font color="#0000b3">ห้องคอมพิวเตอร์ 45 ที่นั่ง</font>)</font></button>
			<button class="tablinks" onclick="openCity(event, '802')" style="height:110px;width:28%;border-bottom:1px solid #000000;float:Right;">66802<br />
		<font size="2">(ห้องเรียน 80 ที่นั่ง)</font></button>
			<button class="tablinks" onclick="openCity(event, '801')" style="height:110px;width:28%;border-bottom:1px solid #000000;float:Right;">66801<br />
		<font size="2">(ห้องเรียน 80 ที่นั่ง)</font></button>
		</div>


		<div class="Hallway">
		<a ><font style="font-size: 30px" color="#a6a6a6">ทางเดิน</font></a>
		</div>


		<div class="tab">
			<button class="tablinks" onclick="openCity(event, '807')" style="height:110px;width:18%;border-top: 1px solid #000000;float:Left;">66807<br />
		<font size="2">(<font color="#cc0066">Marine Simulator Room</font>)</font></button>
			<button class="tablinks" onclick="openCity(event, '806')" style="height:110px;width:18%;border-top: 1px solid #000000;float:Left;">66806<br />
		<font size="2">(<font color="#cc7a00">ห้องคอมพิวเตอร์ 35 ที่นั่ง</font>)</font></button>
		<button class="tablinks" onclick="openCity(event, '805')" style="height:110px;width:18%;border-top: 1px solid #000000;float:Left;">66805<br />
		<font size="2">(<font color="#cc7a00">ห้องคอมพิวเตอร์ 35 ที่นั่ง</font>)</font></button>
			<button class="tablinks" onclick="openCity(event, '804')" style="height:110px;width:28%;border-top: 1px solid #000000;float:Left;">66804<br />
		<font size="2">(<font color="#0000b3">ห้องคอมพิวเตอร์ 45 ที่นั่ง</font>)</font></button>
		</div>
</div>
...
<!----------------------------------------------------------- 801 -------------------------------------------------------------------------->
<div class="tabcontent" id="801">
<p></p>
<h3 style=margin:1 align="center">66801(ห้องเรียน 80 ที่นั่ง)</h3>
<img class="img-room" src="img\801.jpg" alt="801">
...
<!----------------------------------------------------------- 802 -------------------------------------------------------------------------->
<div class="tabcontent" id="802">
<p></p>
<h3 style=margin:1 align="center">66802(ห้องเรียน 80 ที่นั่ง)</h3>
<img class="img-room" src="img\802.jpg" alt="802">
<?php
	ShowBooking(802);
?>
<br>	
...
<!----------------------------------------------------------- 803 -------------------------------------------------------------------------->
<div class="tabcontent" id="803">
<p></p>
<h3 style=margin:1 align="center">66803(ห้องคอมพิวเตอร์ 40 ที่นั่ง)</h3>
<img class="img-room" src="img\803.jpg" alt="803">
<?php
	ShowBooking(803);
?>	
<br>	
...
<!----------------------------------------------------------- 804 -------------------------------------------------------------------------->
<div class="tabcontent" id="804">
<p></p>
<h3 style=margin:1 align="center">66804(ห้องคอมพิวเตอร์ 40 ที่นั่ง)</h3>
<img class="img-room" src="img\804.jpg" alt="804">
<?php
	ShowBooking(804);
?>	
<br>	
...
<!----------------------------------------------------------- 805 -------------------------------------------------------------------------->
<div class="tabcontent" id="805">
<p></p>
<h3 style=margin:1 align="center">66805(ห้องคอมพิวเตอร์ 35 ที่นั่ง)</h3>
<img class="img-room" src="img\805.jpg" alt="805">
<?php
	ShowBooking(805);
?>
<br>
...
<!----------------------------------------------------------- 806 -------------------------------------------------------------------------->
<div class="tabcontent" id="806">
<p></p>
<h3 style=margin:1 align="center">66806(ห้องคอมพิวเตอร์ 35 ที่นั่ง)</h3>
<img class="img-room" src="img\806.jpg" alt="806">
<?php
	ShowBooking(806);
?>
<br>
...
<!----------------------------------------------------------- 807 -------------------------------------------------------------------------->
<div class="tabcontent" id="807">
<p></p>
<h3 style=margin:1 align="center">66807(Marine Simulator Room)</h3>
<img class="img-room" src="img\807.jpg" alt="807">
<?php
	ShowBooking(807);
?>
<br>
...
else if(mysqli_num_rows($result) == 0) 
{
	...
	echo "<fontcolor1>ไม่มีรายการจองใช้ห้องเรียนนอกตาราง</fontcolor1>";
			...
			if(!isset($_SESSION['user'])) 
			{
				echo "&nbsp;[กรุณา <a href='/Other_system/classroom_system/login.php?floor=8' class='acLikeLink'>ล็อคอิน</a> เพื่อจองใช้ห้องเรียนนอกตาราง]";
			}
			else 
			{
